...
onset_size <- ggplot(df_summary_onset, aes(body_size, slope1, fill = species, shape = plot, color = cut(Pvalue1, breaks = c(0, 0.05, 0.099, 1))))+
  ...
  theme(axis.title.x = element_text(size = 12, color = "black", vjust = -1),
        ...
        panel.background = element_rect(color = NA, fill = "lightblue", size = 2))
...
body_size <- ggarrange(onset_size, peak_size, end_size, labels = c("A", "B", "C"), nrow = 1) +
  theme(plot.margin = unit(c(0, 0, 0, 0), "cm"))


#phenological niche

onset_niche <- ggplot(df_summary_onset, aes(average_doy, slope1))+
  geom_hline(yintercept = 0, linetype = "dashed") +
  xlim(179,192)+
  coord_cartesian(ylim=c(-1, 1))+
  geom_errorbar(mapping = aes(ymin = slope1 - SE1, ymax = slope1 + SE1, color = cut(Pvalue1, breaks = c(0, 0.05, 0.099, 1))), width = 0, linewidth = 0.5) + # Adding error bars
  geom_point(df_summary_onset, mapping = aes(average_doy, slope1, fill = species, shape = plot, color = cut(Pvalue1, breaks = c(0, 0.05, 0.099, 1))), size = 3, stroke = 0.6)+
  geom_smooth(df_summary_onset, mapping = aes(average_doy, slope1), method = "lm", se = FALSE, color = "black")+
  scale_shape_manual(values = c(21, 22, 24)) +
...
peak_niche <- ggplot(df_summary_peak, aes(average_doy, slope1))+
  geom_hline(yintercept = 0, linetype = "dashed") +
  xlim(188,212)+
  coord_cartesian(ylim=c(-1, 1))+
  geom_errorbar(mapping = aes(ymin = slope1 - SE1, ymax = slope1 + SE1, color = cut(Pvalue1, breaks = c(0, 0.05, 0.099, 1))), width = 0, linewidth = 0.5) + # Adding error bars
  geom_point(df_summary_peak, mapping = aes(average_doy, slope1, fill = species, shape = plot, color = cut(Pvalue1, breaks = c(0, 0.05, 0.099, 1))), size = 3, stroke = 0.6)+
  geom_smooth(df_summary_peak, mapping = aes(average_doy, slope1), method = "lm", se = FALSE, color = "black")+
  scale_shape_manual(values = c(21, 22, 24)) +
...
end_niche <- ggplot(df_summary_end, aes(average_doy, slope1)) +
  geom_hline(yintercept = 0, linetype = "dashed") +
  xlim(200,232)+
  coord_cartesian(ylim=c(-1, 1))+
  geom_errorbar(mapping = aes(ymin = slope1 - SE1, ymax = slope1 + SE1, color = cut(Pvalue1, breaks = c(0, 0.05, 0.099, 1))), width = 0, linewidth = 0.5) + # Adding error bars
  geom_point(df_summary_end, mapping = aes(average_doy, slope1, fill = species, shape = plot, color = cut(Pvalue1, breaks = c(0, 0.05, 0.099, 1))), size = 3, stroke = 0.6)+
  geom_smooth(df_summary_end, mapping = aes(average_doy, slope1), method = "lm", se = FALSE, color = "black") +
  scale_shape_manual(values = c(21, 22, 24)) +
...
niche <- ggarrange(onset_niche, peak_niche, end_niche, labels = c("G", "H", "I"), nrow = 1) +
  theme(plot.margin = unit(c(0, 0, 0, 0), "cm"))
...
visit <- ggarrange(onset_visit, peak_visit, end_visit, labels = c("D", "E", "F"),  nrow = 1) +
  theme(plot.margin = unit(c(0, 0, 0, 0), "cm"))



snow <- ggarrange(body_size, visit, niche, nrow = 3) 
...
onset_size <- ggplot(df_summary_onset, aes(body_size, slope2, fill = species, shape = plot, color = cut(Pvalue2, breaks = c(0, 0.05, 0.099, 1))))+
  ...
  theme(axis.title.x = element_text(size = 12, color = "black", vjust = -1),
        ...
        panel.background = element_rect(color = NA, fill = "darkseagreen2", size = 2))
        #plot.margin=unit(c(1, 0.1, 0.5, 0), "cm"))
...
onset_niche <- ggplot(df_summary_onset, aes(average_doy, slope2))+
  coord_cartesian(ylim=c(-13, 3))+
  geom_errorbar(mapping = aes(ymin = slope2 - SE2, ymax = slope2 + SE2, color = cut(Pvalue2, breaks = c(0, 0.05, 0.099, 1))), width = 0, linewidth = 0.5) + # Adding error bars
  xlim(179,192)+
  geom_point(df_summary_onset, mapping = aes(average_doy, slope2, fill = species, shape = plot, color = cut(Pvalue2, breaks = c(0, 0.05, 0.099, 1))), size = 3, stroke = 0.6) +
  geom_smooth(df_summary_onset, mapping = aes(average_doy, slope2), method = "lm", se = FALSE, color = "black")+
  geom_hline(yintercept = 0, linetype = "dashed") +
  scale_shape_manual(values = c(21, 22, 24)) +
  #scale_x_continuous(breaks = c(176, 178, 180, 182, 184, 186, 188, 190, 192, 194)) +
  #geom_smooth(method = "lm", se = FALSE, color = "black")+
...
df_summary_onset <- df_summary_onset %>% 
  filter(!(species == "S.almqvistii" & plot == "Art5"))

lm.niche <- lm(slope2 ~ average_doy, df_summary_onset)

summary(lm.niche)

peak_niche <- ggplot(df_summary_peak, aes(average_doy, slope2))+
  #geom_smooth(df_summary_peak, mapping = aes(average_doy, slope2), method = "lm", se = FALSE, color = "black")+
  geom_hline(yintercept = 0, linetype = "dashed") +
  coord_cartesian(ylim=c(-13, 3))+
  ...
  xlim(188,212)+
  geom_point(df_summary_peak, mapping = aes(average_doy, slope2, fill = species, shape = plot, color = cut(Pvalue2, breaks = c(0, 0.05, 0.099, 1))), size = 3, stroke = 0.6) +
  scale_shape_manual(values = c(21, 22, 24)) +
  #scale_x_continuous(breaks = c(186, 190, 194, 198, 202, 206, 210, 214)) +
  #geom_smooth(method = "lm", se = FALSE, color = "black")+
  xlab("")+
...
end_niche <- ggplot(df_summary_end, aes(average_doy, slope2))+
  geom_hline(yintercept = 0, linetype = "dashed") +
  coord_cartesian(ylim=c(-13, 3))+
  geom_errorbar(mapping = aes(ymin = slope2 - SE2, ymax = slope2 + SE2, color = cut(Pvalue2, breaks = c(0, 0.05, 0.099, 1))), width = 0, linewidth = 0.5) + # Adding
  ylim(-13,3)+
  xlim(200,232)+
  geom_point(df_summary_end, mapping = aes(average_doy, slope2, fill = species, shape = plot, color = cut(Pvalue2, breaks = c(0, 0.05, 0.099, 1))), size = 3, stroke = 0.6)+
  geom_smooth(df_summary_end, mapping = aes(average_doy, slope2), method = "lm", se = FALSE, color = "black")+
  scale_shape_manual(values = c(21, 22, 24)) +
  #scale_x_continuous(breaks = c(200, 208, 216, 224, 232, 240)) +
  #geom_smooth(method = "lm", se = FALSE, color = "black")+
  xlab("")+
...
niche <- ggarrange(onset_niche, peak_niche, end_niche, labels = c("G", "H", "I"), vjust = -1.5, nrow = 1) +
  theme(plot.margin = unit(c(0, 0, 0, 0), "cm"))
...
temp <- ggarrange(body_size, visit, niche, nrow = 3) 
  #theme(plot.margin = unit(c(2, 1, 2, 1), "cm"))


ggarrange(snow, temp, ncol = 1, nrow = 2) +
  theme(plot.margin = unit(c(1, 2.5, 1, 2.5), "cm"))
