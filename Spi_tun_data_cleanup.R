...
df_Spitun <- subset(df1, Species_name == "Spi.tun")
...
df2$Species_name[is.na(df2$Species_name)] <- "Spi.tun"
...
write.csv(df2, file = "Data/Species_data_clean\\Spi_tun.csv", row.names =
            FALSE)
