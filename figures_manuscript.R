...
niche_snow <- ggarrange(onset_niche, peak_niche, end_niche, labels = c("A", "B", "C"), 
                        hjust = c(-3, -3, -3), vjust = -1.5, nrow = 1) +
  theme(plot.margin = unit(c(0, 0, 0, 0), "cm"))
...
niche <- ggarrange(onset_niche, peak_niche, end_niche, labels = c("D", "E", "F"), 
                   hjust = c(-3, -3, -3), vjust = -1.5, nrow = 1) +
  theme(plot.margin = unit(c(0, 0, 0, 0), "cm"))


ggarrange(niche_snow, niche, nrow = 3) +
  theme(plot.margin = unit(c(4, 2, 4, 2), "cm"))
